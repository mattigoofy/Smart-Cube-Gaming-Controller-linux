...
class HuffmanTree:
    ...
    def set_frequency_analysis(self, filepath: str) -> None:
        with open(filepath, 'r', encoding="utf-8") as file:
            ...
            number_ghost_nodes = number_of_placeholder_nodes(self.degree, self._number_unique_symbols)
...
class HuffmanTable:
    ...
    def __repr__(self) -> str:
        lines = [f"HuffmanTable (bits_per_edge={self.bits_per_edge}, {len(self.mapping)} symbols)"]
